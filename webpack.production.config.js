    ...
    module: {
        rules: [
            ...
            },
            {
                ...
                use: ['url-loader?limit=10000&mimetype=application/font-woff&name=[hash].[ext]'],

            },
            {
                test: /\.ttf(\?v=\d+\.\d+\.\d+)?$/,
                use: ['url-loader?limit=10000&mimetype=application/octet-stream&name=[hash].[ext]']
            },
            {
                test: /\.eot(\?v=\d+\.\d+\.\d+)?$/,
                use: ['file-loader?name=[hash].[ext]\'']
            ...
            {
                test: /\.svg(\?v=\d+\.\d+\.\d+)?$/,
                use: ['url-loader?limit=10000&mimetype=image/svg+xml&name=[hash].[ext]']
            },
            {
                test:/(\.jsx|\.js)$/,
